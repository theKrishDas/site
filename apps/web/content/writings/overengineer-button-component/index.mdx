...
<figure className="[&_img]:m-0 [&_p]:m-0">
  ...
  button](https://takjwz0vsb.ufs.sh/f/OXSIOmPScgezWnujBG2kZd5e8FPpWCi3vmTyOc6zhtoDKMXU)
...
<figure className="[&_img]:m-0 [&_p]:m-0">
  ...
  pointer](https://takjwz0vsb.ufs.sh/f/OXSIOmPScgezw7hMHoRRTnGYDmqspXNFK7QjS2vy8g6kV5Eo)
...
<figure className="[&_img]:m-0 [&_p]:m-0">
  ...
  release](https://takjwz0vsb.ufs.sh/f/OXSIOmPScgez4PNlVFJsGWB3kXE2A9LmrnUI1cVyFquHeCPt)
...
<figure className="[&_img]:m-0 [&_p]:m-0">
  ...
  focus](https://takjwz0vsb.ufs.sh/f/OXSIOmPScgezcsO3SYMp6HSyx8i5GPOmF74AKsjNJ9Q3heMo)
