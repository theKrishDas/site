...
<figure className="[&_img]:m-0 [&_p]:m-0">
  <Img
    src="https://tfbt3dh6hk.ufs.sh/f/Ty4EmORQRe5meOBScHF3NOgATz8V4irJuGcIEHvwablKtDUk"
    alt="Button remains highlighted while the touch indicator moves outside the
  button"
  />
  <figcaption>
...
<figure className="[&_img]:m-0 [&_p]:m-0">
  <Img
    src="https://tfbt3dh6hk.ufs.sh/f/Ty4EmORQRe5ms65sHqg7RO8G4cYhHF96rNPw0MUiqZE1tfpB"
    alt="Focus ring remains visible while clicking the button with a
  pointer"
  />
  <figcaption>
...
<figure className="[&_img]:m-0 [&_p]:m-0">
  <Img
    src="https://tfbt3dh6hk.ufs.sh/f/Ty4EmORQRe5mBflVrWvPBp9HlJugRMjTYVx34nfZrwQS5oXL"
    alt="Pressed state is removed when the pointer leaves the button before
  release"
  />
  <figcaption>
...
<figure className="[&_img]:m-0 [&_p]:m-0">
  <Img
    src="https://tfbt3dh6hk.ufs.sh/f/Ty4EmORQRe5mAaKVJiC6RicqQzUJGOKPNvu1x05WlYSfEFZX"
    alt="Focus ring is removed after a pointer interaction replaces keyboard
  focus"
  />
  <figcaption>
